...
namespace OFAuth.Models
{
    ...
    public class PostV2AccessPostsRequest
    {
        ...
        /// <summary>Whether text is locked behind paywall</summary>
    ...
    public class GetV2AccessPromotionsPromotionIdResponse
    {
    ...
    public class PostV2AccessPromotionsPromotionIdFinishResponse
    {
